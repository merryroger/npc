    ...
    <header>
            ...
            <aside class="haside haside__right">
                <div id="top__controls">
                    <form id="search" action="/search">
                        <a href="/search" class="search__rq__button" onclick="return toggleSearchPanel(this, '')" title="Поиск"></a>
                        <input type="text" id="search__text" name="search__text" value="" class="search__fields sp__hidden" tabindex="1" autofocus />
                    </form>
                </div>
            </aside>
        </section>
        ...
        <nav class="sq__ctrls">
            ...
            <form id="search2" action="/search">
                <a href="/search" class="search__rq__button" onclick="return toggleSearchPanel(this, '2')" title="Поиск"></a>
                <input type="text" id="search__text2" name="search__text" value="" class="search__fields sp__hidden" tabindex="1" autofocus />
            </form>
        </nav>
    </header>
    <section id="mainpad">
        ...
        <section class="main__sheet">
            ...
            <article>
                <h2>О центре</h2>
                <p>ГКУ «Научно-производственный центр по охране и использованию объектов культурного наследия (памятников истории и культуры) Курганской области» является производственной структурой в области охраны объектов культурного наследия.</p>
                <p>Основные виды деятельности: обследование, изучение и документирование объектов культурного наследия.</p>
                <p>ГКУ НПЦ проводит историко-архивные, научно-исследовательские, проектно-изыскательские работы, готовит акты технического состояния, определяет границы охраняемого объекта, осуществляет надзор за ремонтно-реставрационными работами.</p>
                <p>В штате ГКУ НПЦ имеются специалисты по архитектуре и строительству, археологии, гео-информационным системам.</p>
            </article>
        ...
        <aside class="page__aside aside__right">
            <section id="news">
                ...
                <div class="list__container">
                    <a href="/" class="news">
                        <div class="news__image"><h6>21.05.2021</h6><img src="/images/news/preview/savin.jpg" alt="На Савин" /></div>
                        <p>Мастер-классы по чеканке монет, стрельбе из лука, народные игры – гостей первого этнофестиваля «Едем на Савин» ждёт настоящий исторический праздник.</p>
                    </a>
                    <a href="/" class="news">
                        <div class="news__image"><h6>17.05.2021</h6><img src="/images/news/preview/savin-1.jpg" alt="На Савин" /></div>
                        <p>Святилище «Савин» заинтересовало российских туроператоров.</p>
                    </a>
                    <a href="/" class="news">
                        <div class="news__image"><h6>29.04.2021</h6><img src="/images/news/preview/pamyatnik.jpg" alt="Памятник погибшим в Великой Отечественной войне" /></div>
                        <p>Губернатор Вадим Шумков вместе со школьниками привёл в порядок памятник погибшим в Великой Отечественной войне.</p>
                    </a>
                    <a href="/" class="news extra__news">
                        <div class="news__image"><h6>24.04.2021</h6><img src="/images/news/preview/sad_pamyati.jpg" alt="Сад памяти" /></div>
